...
path = "./images/figure_space_decryption.png"
...
if __name__ == "__main__":
    ...
    y_rsa = np.log10(rsa_decryption_regs_v)
    ...
    y_ecc_p = np.log10(ecc_p_decryption_regs_v)
    ...
    y_ecc_p2 = np.log10(ecc_p_decryption_regs_v2)
