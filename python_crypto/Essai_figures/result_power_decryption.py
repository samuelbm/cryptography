...
path = "./images/figure_power_decryption.png"
...
if __name__ == "__main__":
    ...
    y_rsa = np.log10(rsa_decryption_gates_v)
    ...
    y_ecc_p = np.log10(ecc_p_decryption_gates_v)
    ...
    #ax.plot(x, y_ecc_p_trend, label="ECC $GF(p)$ régression", linewidth=linewidth)
    ax.plot(x, y_ecc_p_trend, label="", linewidth=linewidth)


    x_ecc_p2 = np.log2(ecc_p_equivalent2)
    y_ecc_p2 = np.log10(ecc_p_decryption_gates_v2)
