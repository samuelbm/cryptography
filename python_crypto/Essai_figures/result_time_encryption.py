...
if __name__ == "__main__":
    ...
    y_rsa = np.log10(rsa_encryption_clock_v)
    ...
    y_ecc_p = np.log10(ecc_p_encryption_clock_v)
    ...
    y_ecc_p2 = np.log10(ecc_p_encryption_clock_v2)
    ...
    #x.plot(x, y_ecc_p_trend2, label="ECC $GF(p)$ sans inversion régression", linewidth=linewidth)
