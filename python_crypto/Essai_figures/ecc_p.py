...
def ecc_p_192(tries):
    ...
    path = "./data/ecc_p_192_without_inversion.txt"
    random.seed(1234)
    m = 123
    size = 192
...
def ecc_p_256(tries):
    ...
    path = "./data/ecc_p_256_without_inversion.txt"
    random.seed(1234)
    m = 123
    size = 256
    for i in range(tries):
...
def ecc_p_384(tries):
    ...
    path = "./data/ecc_p_384_without_inversion.txt"
    random.seed(1234)
    m = 123
    size = 384
    for i in range(tries):
...
def ecc_p_521(tries):
    ...
    path = "./data/ecc_p_521_without_inversion.txt"
    random.seed(1234)
    m = 123
    size = 521
    for i in range(tries):
